...
import ng.samuel.notdemo.ebankingms.customerservice.configuration.ApplicationProps;
...
public class JWTAuthorizationFilter extends OncePerRequestFilter {
    ...
    private final ApplicationProps properties;

    public JWTAuthorizationFilter(ApplicationProps properties) {
